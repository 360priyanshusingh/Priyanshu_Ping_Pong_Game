...
(function () {
    ...
    if (rod === "null" || maxScore === "null") {
        ...
        alert("Right shift 'PRESS' R bottun  &  Left shift 'PRESS' L bottun")
        maxScore = 0;
        rod = "Rod1"
    } else {
...
window.addEventListener('keypress', function () {
    ...
    if (event.code === "KeyL" && ((rodRect.x + rodRect.width) < window.innerWidth)) {
        rod1.style.left = (rodRect.x) + rodSpeed + 'px';
        rod2.style.left = rod1.style.left;
    } else if (event.code === "KeyR" && (rodRect.x > 0)) {
        rod1.style.left = (rodRect.x) - rodSpeed + 'px';
        rod2.style.left = rod1.style.left;
    }
